    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                {
                    case 1:
                        Console.WriteLine("Escogiste construir un Arbol binario");
                        Program.construirArbolB();
                        Console.WriteLine("Presione una tecla para continuar");
                        Console.ReadLine();
                        break;
                    case 2:
                        Console.WriteLine("Escogiste construir un Arbol de Multiples Hijos");
                        Program.construirArbolMultiplesHijos();
                        Console.WriteLine("Presione una tecla para continuar");
                        Console.ReadLine();
                        break;
                    case 3:
                        Console.WriteLine("Escogiste contar niveles de un Arbol de Mutiples Hijos");
                        Program.contarNiveles();
                        Console.WriteLine("Presione una tecla para continuar");
                        Console.ReadLine();
                        break;
                    case 4:
                        Console.WriteLine("Escogiste contar hojas de un Arbol de Mutiples Hijos");
                        Program.contarHojas();
                        Console.WriteLine("Presione una tecla para continuar");
                        Console.ReadLine();
                        break;
                    case 5:
                        Console.WriteLine("Escogiste contar nodos de un Arbol de Mutiples Hijos");
                        Program.contarNodos();
                        Console.WriteLine("Presione una tecla para continuar");
                        Console.ReadLine();
                        break;
                    case 6:
                        Console.WriteLine("Escogiste navegación horizontal POSTORDEN");
                        Program.NavegarHorizontalmente();
                        Console.WriteLine("Presione una tecla para continuar");
                        Console.ReadLine();
                        break;
                    case 7:
                        Console.WriteLine("Escogiste operar mediante una expresión matematica");
                    ...
                    case 8:
                        ...
                        break;
                    default:
                        Console.WriteLine("La opción escogida no existe en el menú, vuelva a intentarlo por favor");
                        Console.WriteLine("Presione una tecla para continuar");
                        Console.ReadLine();
                        break;
                }
        ...
        public static void contarHojas()
        {
            ...
            NodoExt.ImprmirArbolMultiplesHijos(nodoA);
            Console.WriteLine("El arbol tiene {0} Hojas !!!", NodoExt.ContarHojas(nodoA));
